...
You will receive the following output:_
            ...
            Executing command account show_

            Name              : Sysgain-Backup_

            ID                :-YOUR-GUID-HERE-c3d05c01a287**

            State             : Enabled_

            Tenant ID         :a2b2d6bc-YOUR-GUID-HERE-f97a7ac416d7

            Is Default        : true_

            Environment       : AzureCloud_

            Has Certificate   : No_

            Has Access Token  : Yes_

            User name         : username@sysgaininc.onmicrosoft.com_

            info                  :    account show command OK_
